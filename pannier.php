...
<div class="container pannier white">
    ...
    <br>
    <div class="right">
        <h6 class="left" style="margin-right:10px;">total : <?=$total?> DHs</h6>
        <input type='submit' name='passerCmd' class="btn right green" value="<?=$lang['commander']?>"/> 
        <input type="submit" name="refresh" class="btn green" style="margin-right: 10px;" value="<?=$lang['refresh']?>">
    </div>
    </form>
