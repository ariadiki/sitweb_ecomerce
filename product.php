    ...
    <div class="pro_images">
        ...
        <div class="right details_table">
            <table>
                ...
                <tr>
                    <td colspan="2" align='right'><input type='submit' name='add' style='width: 100%;' class="btn green" value="<?=$lang['acheter']?>"></td>
                </tr>
                </form>
            </table>
        </div>
                ...
                <form class="col s12" method="post">
                  <div class="row" style="margin-bottom:0;">
                    <div class="input-field comment col s12">
                      ...
                      <input type="submit" class="waves-effect waves-light btn right green" name="commenter" value="commenter">
                    </div>
                  </div>
                </form>
                <?php
