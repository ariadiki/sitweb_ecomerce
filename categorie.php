        ...
        <div class="col s12 m3">
            <div class="card">
                <a href="product.php?pid=<?=$pro['p_id']?>">
                    ...
                    ?>
                    <a href="?action=addtocard&pid=<?=$pro['p_id']?>" class="addtocart waves-effect green"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
                    </div>
                </a>
                <div class="card-content">
                    <span class="card-title grey-text text-darken-4">
                        <a href="product.php?pid=<?=$pro['p_id']?>" class="green-text"><?=$pro['p_title']?></a><i class="material-icons activator right Points">more_vert</i></span>
                    <div class="prises">
                        <?php
                            if($pro['p_promo']!=0){
                ...
                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4"><?=$pro['p_title']?>
